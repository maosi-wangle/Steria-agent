...
class DefaultMemoryEngine:
    ...
    def __init__(
        ...
        *,
        ...
        self._v2_store = MemoryStore2(db_path, vec_dim=embedding.embed_dim)
        self._embedder = Embedder(
            ...
            dimensions=embedding.embed_dim,
    ...
    def ensure_workspace_storage(
        ...
        *,
        ...
        store = MemoryStore2(db_path, vec_dim=config.memory.embedding.embed_dim)
        store.close()
